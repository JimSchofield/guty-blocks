...
class ReactLive extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    constructor() {
        super();
        this.state = {
            text: ''
...
window.onload = function () {
    __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(wp.element.createElement(ReactLive, null), document.getElementById('live-react') || null);
};
