...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__react_view_editor_css__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__react_view_editor_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__react_view_editor_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__react_view_view_scss__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__react_view_view_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__react_view_view_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_Editor_jsx__ = __webpack_require__(49);
...
class Editor extends __WEBPACK_IMPORTED_MODULE_0_react___default.a.Component {
    ...
    fetchSomePosts(pageIndex) {
        fetch(`/wp-json/wp/v2/posts/?per_page=30&page=${pageIndex}`).then(res => {
    ...
    render() {
        ...
        return wp.element.createElement(
            ...
            this.state.currentPage > 1 && wp.element.createElement(
                'button',
                { onClick: this.pageBack },
                'Previous 20'
            ),
            this.state.currentPage < this.state.totalPages && wp.element.createElement(
                'button',
                { onClick: this.pageUp, style: { float: 'right' } },
                'Next 20'
            )
        );
    }
